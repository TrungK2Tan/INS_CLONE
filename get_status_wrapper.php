...
<div class="status-wrapper">
    <?php foreach($other_people as $person){ ?>
        <form action="other_user_profile.php" id="other_user_form_<?php echo  $person['id']; ?>" method="post">
        <div class="status-card">
            <input type="hidden" name="other_user_id" value="<?php echo $person['id']; ?>">
            <div class="profile-pic">
                <img onclick="document.getElementById('other_user_form_<?php echo $person['id']; ?>').submit();" 
