        ...
        <div class="camera">
            <div class="camera-image">
                ...
                <form action="update_post.php" method="post" enctype="multipart/form-data" class="camera-form">
                    ...
                    <div class="form-group">
                        <input type="text" name="caption" class="form-control" placeholder="type captions" value="<?php echo $post['caption'];?>">
                    </div>
                    <div class="form-group">
                        <input type="text" name="hashtags" class="form-control" placeholder="type hasktga" value="<?php echo $post['hashtags'];?>">
                    </div>
                    <div class="form-group">
                        <button type="submit" name="update_post_btn" class="upload-btn">update Post</button>
                    </div>
                </form>
            </div>
        </div>
